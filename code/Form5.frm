VERSION 5.00
Begin VB.Form FrmAfdrukvoorbeeld 
   BackColor       =   &H8000000E&
   BorderStyle     =   0  'None
   Caption         =   "Form5"
   ClientHeight    =   1695
   ...
   End
End
Attribute VB_Name = "FrmAfdrukvoorbeeld"
...
Resto = Mid(TxtEan, 2, 12)
                        PEan.Line (50, 135)-(220, 135), &H0&
                        PEan.Line (50, 165)-(220, 165), &H0&
                            If Inicial <> "0" Then
                                PEan.CurrentY = -20
                                PEan.CurrentX = 300
                                PEan.Print Inicial
            ...
            For Grupo = 1 To 2
                ...
                Select Case Grupo
                    Case 1
                        PEan.Line (50, y + 30)-(220, y + 30), &H0&
                        PEan.Line (50, y + 60)-(220, y + 60), &H0&
                    Case 2
                        PEan.Line (50, y + 15)-(220, y + 15), &H0&
                        PEan.Line (50, y + 45)-(220, y + 45), &H0&
                End Select
            Next Grupo
        End If
   ' End If
...
SavePicture Clipboard.GetData(vbCFBitmap), App.Path & "\images\EAN\EAN" & Form1.Text1.Text & ".jpg"
Clipboard.Clear


Form1.Image1.Picture = LoadPicture(App.Path & "\images\EAN\EAN" & Form1.Text1.Text & ".jpg")
