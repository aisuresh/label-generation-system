...
On Error GoTo Err01:
    ...
    If Combo13.Text = "" Then p = 1
    If Combo14.Text = "" Then p = 1
    If Combo15.Text = "" Then p = 1
    If Combo16.Text = "" Then p = 1
    If Combo17.Text = "" Then p = 1
    If Combo18.Text = "" Then p = 1
    If Combo19.Text = "" Then p = 1
    If Combo20.Text = "" Then p = 1
    If Combo21.Text = "" Then p = 1
    If Combo22.Text = "" Then p = 1
    If Combo23.Text = "" Then p = 1
    If Combo24.Text = "" Then p = 1
    If Combo25.Text = "" Then p = 1
    If Combo26.Text = "" Then p = 1
    If Combo27.Text = "" Then p = 1
    If Combo28.Text = "" Then p = 1
    If Combo29.Text = "" Then p = 1
    If Combo30.Text = "" Then p = 1
    If Combo31.Text = "" Then p = 1
    If Combo32.Text = "" Then p = 1
    If Combo33.Text = "" Then p = 1
    If p = 1 Then MsgBox "Alle velden moeten worden ingevuld. Let op ! Er mogen geen dubbele nummers worden gebruikt."
    
    If p = 0 Then MDIForm1.Show
Exit Sub
Err01:
...
Private Sub Timer1_Timer()
    ...
    rs.Open "SELECT * FROM btch01 ORDER BY sticker_id", Cn
    ...
    If rs.EOF <> True And rs.BOF <> True Then
      ...
      Set itmx = ListView1.ListItems.Add(, , rs(0))
           ...
           If rs(1) > 0 Then strlev_naam = rs(1)       'lev_naam
            ...
            If p = 13 Then Combo13.Text = rs(0)
            If p = 14 Then Combo14.Text = rs(0)
            If p = 15 Then Combo15.Text = rs(0)
            If p = 16 Then Combo16.Text = rs(0)
            If p = 17 Then Combo17.Text = rs(0)
            If p = 18 Then Combo18.Text = rs(0)
            If p = 19 Then Combo19.Text = rs(0)
            If p = 20 Then Combo20.Text = rs(0)
            If p = 21 Then Combo21.Text = rs(0)
            If p = 22 Then Combo22.Text = rs(0)
            If p = 23 Then Combo23.Text = rs(0)
            If p = 24 Then Combo24.Text = rs(0)
            If p = 25 Then Combo25.Text = rs(0)
            If p = 26 Then Combo26.Text = rs(0)
            If p = 27 Then Combo27.Text = rs(0)
            If p = 28 Then Combo28.Text = rs(0)
            If p = 29 Then Combo29.Text = rs(0)
            If p = 30 Then Combo30.Text = rs(0)
            If p = 31 Then Combo31.Text = rs(0)
            If p = 32 Then Combo32.Text = rs(0)
            If p = 33 Then Combo33.Text = rs(0)
            ...
            Combo13.AddItem rs(0)
            Combo14.AddItem rs(0)
            Combo15.AddItem rs(0)
            Combo16.AddItem rs(0)
            Combo17.AddItem rs(0)
            Combo18.AddItem rs(0)
            Combo19.AddItem rs(0)
            Combo20.AddItem rs(0)
            Combo21.AddItem rs(0)
            Combo22.AddItem rs(0)
            Combo23.AddItem rs(0)
            Combo24.AddItem rs(0)
            Combo25.AddItem rs(0)
            Combo26.AddItem rs(0)
            Combo27.AddItem rs(0)
            Combo28.AddItem rs(0)
            Combo29.AddItem rs(0)
            Combo30.AddItem rs(0)
            Combo31.AddItem rs(0)
            Combo32.AddItem rs(0)
            Combo33.AddItem rs(0)
